    ...
    return (
        <AsideStyled>
          ...
          document.addEventListener('DOMContentLoaded', () => {
            	timerMilisec('.aside', 50) // timerMilisec(Родитель, Секунды)
            })
        </script> */}
            ...
            <a className="aside__fight" href="list-games.html">
