...
import {setPopup, setSound, setUser} from '../../../../redux/toolkitSlice'
...
export const Burger: React.FC<IBurgerProps> = () => {
    ...
    const handleOpenModalPay = () => {
        ...
        dispatch(setPopup('popup-add-coins'))
    }
