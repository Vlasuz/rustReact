        ...
        <>

            {
                player.bags.map((bag: any) =>
                    ...
                    <li className="point" key={bag.x_pos + bag.y_pos + player.user.id} style={{left: `${bag.x_pos * 1500}px`, top: `${bag.y_pos * 1500}px`}}>
                        <div className="point__group">
                            ...
                            <div className="point__winner-table">
                                <div className="table__left"
                                     style={{background: "linear-gradient(89.07deg, rgb(205, 64, 42) 0.69%, rgb(55, 20, 20) 99.35%)"}}>
                                    <img src={player.user.avatar} alt="Photo"/>
                                    <span className="">
                                        {player.user.name}
                                    </span>
                            ...
                            <div className="point__dot">
                                <div className="line" style={{background: isYourUser ? "rgb(205, 64, 42)" : "rgb(146, 193, 69)"}}/>
                                <div className="dot" style={{background: isYourUser ? "rgb(205, 64, 42)" : "rgb(146, 193, 69)"}}/>
                            </div>
                        </div>
                    </li>
                )
