                ...
                <GameState.Provider value={gameStep}>
                    <BattleSingleStyled ref={blockArea}>
                        ...
                        <div className="battle-area">
                            {webSocket?.battle.status === "waiting" && webSocket?.battle?.players?.some((item: any) => item.user.id === userData.id) && <button onClick={handleCancelGame} className="battle-area__back">
                            ...
                            <BattleArea setIsYouWin={setIsYouWin} setGameStep={setGameStep} gameType={gameType} blockArea={blockArea}/>
