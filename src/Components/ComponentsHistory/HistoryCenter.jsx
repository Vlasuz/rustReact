...
const HistoryCenter = (props) => {
    ...
    const switcherType = (e) => {
        ...
        setTimeout(() => {
            props.setChangeHistoryList({...props.changeHistoryList, switcher_type: e.target.closest('button').className})
        ...
        <div className="section-history__center">
            <ul className="section-history__switcher">
                <li className="switcher-type__all li_active">
                    <button
                        onClick={e => switcherType(e)}
                    >Все</button>
                </li>
                <li>
                    <button
                        className="switcher-type__items"
                        onClick={e => switcherType(e)}
                    >Предметами</button>
                </li>
                <li>
                    <button
                        className="switcher-type__pin-codes"
                        onClick={e => switcherType(e)}
                    >Пин-коды</button>
                </li>
            </ul>
